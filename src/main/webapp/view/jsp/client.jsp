...
<body background="static/image/5611.jpg">
		...
		<div class="navbar navbar-inverse">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="loginclient">Client Login</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<c:choose>
		...
		<c:when
			...
			<%-- outputVal: ${client.email} --%>
			<%-- <c:out value = "client.email"/> --%>

		</c:when>
		<c:when test="${mode == 'MODE_CLIENT_LOGIN'}">
			<div class="container text-center">
				<h2 class="fhd1text">Login Here</h2>
				<hr>
				<form class="form-horizontal" method="POST" action="loginclient">
					<input type="hidden" name="email" value="${client.email}" />
					<div class="form-group">
						<label class="control-label col-md-3 fl6text">Your Email</label>
						<div class="col-md-7">
							<input type="text" class="form-control" name="email"
								value="${client.email}" />
						</div>
					...
					<div class="form-group">
						<label class="control-label col-md-3 fl7text">Your Password</label>
						<div class="col-md-7">
							<input type="password" class="form-control" name="password"
								value="${client.password}" />
						</div>
